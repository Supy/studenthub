...
RSpec.describe Book, :type => :model do
    ...
    context 'with Google Books loaded data' do
        let(:valid_google_books_attributes) {
            {
                "volumeInfo" => {
        ...
        it 'should populate a valid Book model if all required keys are present' do
            book = Book.from_google_books(valid_google_books_attributes)
        ...
        it 'should return nil Book object' do
            valid_google_books_attributes['volumeInfo'].delete('title')
            book = Book.from_google_books(valid_google_books_attributes)
        ...
        it 'should have nil thumbnail_url attribute if not available' do
            valid_google_books_attributes['volumeInfo'].delete('imageLinks')
            book = Book.from_google_books(valid_google_books_attributes)
